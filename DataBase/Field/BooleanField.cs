...
namespace Birko.Data.DataBase.Field
{
    ...
    {
        public BooleanField(System.Reflection.PropertyInfo property, string name, bool primary = false, bool unique = false, bool autoincrement = false)
            : base(property, name, DbType.Boolean, primary, true, unique, autoincrement)
        {
        }
    ...
    {
        public NullableBooleanField(System.Reflection.PropertyInfo property, string name, bool primary = false, bool unique = false, bool autoincrement = false)
