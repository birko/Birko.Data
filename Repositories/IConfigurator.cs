...
namespace Birko.Data.Repositories
{
    public interface IConfigurator
    {
        ...
        /// </summary>
        void PreMigrate<T, TModel, TSettings>(IRepository<T, TModel> repository)
        ...
        /// </summary>
        void Migrate<T, TModel, TSettings>(IRepository<T, TModel> repository)
            where T : Models.ILoadable<TModel>
            where TModel : Models.AbstractModel, Models.ILoadable<T>;
        /// <summary>
        ...
        /// </summary>
        void PostMigrate<T, TModel, TSettings>(IRepository<T, TModel> repository)
            where T : Models.ILoadable<TModel>
            where TModel : Models.AbstractModel, Models.ILoadable<T>;
        /// <summary>
        ...
        /// </summary>
        void Seed<T, TModel, TSettings>(IRepository<T, TModel> repository)
            where T : Models.ILoadable<TModel>
            where TModel : Models.AbstractModel, Models.ILoadable<T>;
    }
}
