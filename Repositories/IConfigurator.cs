...
namespace Birko.Data.Repositories
{
    public interface IConfigurator
    {
        ...
        /// </summary>
        void PreMigrate<T, TModel>(IRepository<T, TModel> repository) where TModel: Models.AbstractModel;
        /// <summary>
        /// Update the repository schema
        /// The final task must be to update the version number in Sqlite
        /// </summary>
        void Migrate<T, TModel>(IRepository<T,TModel> repository) where TModel : Models.AbstractModel;
        /// <summary>
        ...
        /// </summary>
        void PostMigrate<T, TModel>(IRepository<T, TModel> repository) where TModel : Models.AbstractModel;
        /// <summary>
        ...
        /// </summary>
        void Seed<T, TModel>(IRepository<T, TModel> repository) where TModel: Models.AbstractModel;
    }
}
